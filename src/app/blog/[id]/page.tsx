...
const page = ({ params }: { params: { id: string } }) => {
    return (
        ...
        >
            ...
            <div
                className="col-span-8 space-y-main-content-gap bg-primary dark:bg-darkMode-contentBG border box-border-color rounded-common overflow-hidden pb-common"
            >
                <BlogMainContent />
            </div>
            <div
                className="col-span-3 space-y-common-.75"
            >
                <BlogRIghtUserCart />
